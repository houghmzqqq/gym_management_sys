	...
	<div class="sidebar-nav">
		<ul>
			...
			<li><ul class="premium-menu nav nav-list collapse">
					...
					<li><a href="${pageContext.request.contextPath}/equ/findForClient?thisPage=1&equTypeId=0">
				...
				<tbody>
					<c:forEach var="orderItem" items="${equOrderItemVOs }"
						...
						<tr>
							...
							<td>${orderItem.equBreakCount }</td>
							<td>${orderItem.equCompensation }</td>
							<td>${orderItem.itemSum }</td>
							<td>${orderItem.itemDeposit }</td>
							<td><a href="${pageContext.request.contextPath}/equOrder/turnToItemUpdate?equOrderItemId=${orderItem.equOrderItemId}" 
							role="button" data-toggle="modal"><i class="fa fa-pencil"></i></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
