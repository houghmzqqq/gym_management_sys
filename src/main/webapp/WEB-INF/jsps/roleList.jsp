 ...
 <body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="roleList"><span class="fa fa-caret-right"></span> 角色列表</a></li>
...
<table class="table">
  ...
  <tr>
      <td>${role.roleId}</td>
      <td><c:choose>
      	<c:when test="${role.roleName == '超级管理员' }">
      		<span class="label label-danger">${role.roleName }</span>
      	</c:when>
      	<c:when test="${role.roleName == '普通用户' }">
      ...
      <!--  <td>
          ...
          <a href="#myModal" class="deleteAdmin" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
      </td>-->
    </tr>
  </c:forEach>
  </tbody>
