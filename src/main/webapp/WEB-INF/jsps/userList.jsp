 ...
 <body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="userList"><span class="fa fa-caret-right"></span> 用户列表</a></li>
    </ul></li>
...
<li><a href="#" data-target=".legal-menu"
  ...
  <c:forEach items="${userList}" var="user" >
    <tr>
      ...
      <td>${user.name }<br></td>
      <td><span class="label label-success">${user.userRole }</span></td>
      <td><span class="text-sm"> <a href="userDetail/${user.userName }" class="padding-right-small"><i class="fa fa-book "></i> 详细信息</a></span></td>
    </tr>
    </c:forEach>
  </tbody>
</table>
