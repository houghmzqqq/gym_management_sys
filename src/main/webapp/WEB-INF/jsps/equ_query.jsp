          ...
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <c:choose>
                    	<c:when test="${role == '普通用户' }">${user.name}</c:when>
                    	<c:otherwise>${user.relName }</c:otherwise>
                    </c:choose>
	...
	<div class="sidebar-nav">
		<ul>
			...
			<li><ul class="premium-menu nav nav-list collapse in">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/equClient/findForClient?thisPage=1&equTypeId=0"><span 
	...
	<div class="content">
		...
		<div class="main-content">
			...
			<div class="btn-toolbar list-toolbar">
				...
				<form action="${pageContext.request.contextPath }/equClient/findForClient"
					method="get">
			...
			<ul class="pagination">
				<li><a
					href="${pageContext.request.contextPath }/equClient/findForClient?thisPage=${dividePage.prePage}&equTypeId=${equTypeId}">&laquo;</a></li>
				...
				<c:forEach begin="${start}" end="${end}" step="1" var="i">
					...
					<c:if test="${i != dividePage.thisPage}">
						<li><a
							href="${pageContext.request.contextPath}/equClient/findForClient?thisPage=${i}&equTypeId=${equTypeId}">${i}</a></li>
					</c:if>
				</c:forEach>
				<li><a
					href="${pageContext.request.contextPath }/equClient/findForClient?thisPage=${dividePage.nextPage}&equTypeId=${equTypeId}">&raquo;</a></li>
			</ul>
			<hr>
