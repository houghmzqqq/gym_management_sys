...
<html>
  ...
  <!--<![endif]-->
    ...
    <div class="panel panel-default">
        <p class="panel-heading no-collapse">普通用户登陆</p>
        <div class="panel-body">
            <form method="post" action="${pageContext.request.contextPath}/login/userLogin">
    ...
    <p><a href="${pageContext.request.contextPath}/user/signUp">注册</a>
    <a href="${pageContext.request.contextPath}/login/admin">管理员登录</a></p>
</div>
