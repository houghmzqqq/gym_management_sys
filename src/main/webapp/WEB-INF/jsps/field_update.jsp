...
.navbar-default .navbar-brand, .navbar-default .navbar-brand:hover {
	...
	<div class="content">
		<div class="header">
			...
			<h1 class="page-title">场地信息修改</h1>
			<ul class="breadcrumb">
				<li><a href="index.html">Home</a></li>
				<li><a href="equipments.html">field</a></li>
				<li class="active">field_update</li>
			</ul>
				...
				<div class="col-md-4">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form id="tab" action="${pageContext.request.contextPath }/field/update" method="post">
								<input name="fieldId" type="hidden"
										value="${fieldVO.fieldId }" class="form-control">
								<div class="form-group">
									<label>场地名称</label> <input name="fieldName" type="text"
										value="${fieldVO.fieldName }" class="form-control">
								</div>
								<div class="form-group">
									<label>类型</label> 
									<select name="fieldTypeId"
										...
										<c:forEach var="fieldTypeVO" items="${fieldTypeVOs }">
											<option<c:if test="${fieldVO.fieldTypeId == fieldTypeVO.fieldTypeId }">
											selected="selected"</c:if> value="${fieldTypeVO.fieldTypeId }">${fieldTypeVO.fieldTypeName }</option>
										</c:forEach>
									</select>
								</div>
								<div class="form-group">
									...
									<select name="fieldStatement"
										id="DropDownTimezone" class="form-control">
										<c:choose><c:when test="${fieldVO.fieldStatement == 0 }">
											<option value="0">可用</option></c:when>
										<c:when test="${fieldVO.fieldStatement == 0 }">
											<option value="1">维修中</option></c:when></c:choose>
									</select>
								</div>
								<div class="form-group">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href="${pageContext.request.contextPath }/field/remove?fieldId=${fieldVO.fieldId}" data-toggle="modal" class="btn btn-danger">删除</a>
						</div>
					</div>
				</div>
			</div>
