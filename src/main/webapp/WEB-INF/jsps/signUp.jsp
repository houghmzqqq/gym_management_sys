  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> HRM</span></a></div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" action="${pageContext.request.contextPath}/user/doSignUp">
                ...
                <div class="form-group">
                    <label>确认密码</label>
                    <input type="password" name="comfirmPsw" class="form-control span12" required>
                </div>
                <div class="form-group">
                    <label>真实姓名</label>
                ...
                <div class="form-group">
                    <label>身份证号码</label>
                    <input type="text" name="idCode" class="form-control span12" required>
                </div>
                <div class="form-group">
                    <label>联系电话</label>
                    <input type="text" name="telephone" class="form-control span12" required>
                </div>
                <div class="form-group">
                    <label>密保问题</label>
                    <input type="text" name="question" class="form-control span12" required>
                </div>
                <div class="form-group">
                    <label>密保答案</label>
                    <input type="text" name="answer" class="form-control span12" required>
                </div>
                <div class="form-group">
