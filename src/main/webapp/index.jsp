			...
			<ul id="main-menu" class="nav navbar-nav navbar-right">
				<li class="dropdown hidden-xs"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <span
						...
						style="position: relative; top: 3px;"></span>${user.name} <i
						class="fa fa-caret-down"></i>
				</a>

					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/user/personalDeatil">我的账户</a></li>
						<li class="divider"></li>
						<li class="dropdown-header">个人面板</li>
						<li class="divider"></li>
						<li><a tabindex="-1"
							href="${pageContext.request.contextPath}/login/logout">退出</a></li>
					</ul></li>
			</ul>
	...
	<div class="sidebar-nav">
		<ul>
			...
			<li><ul class="premium-menu nav nav-list collapse">
					...
					<li><a
						href="${pageContext.request.contextPath}/equClient/findForClient?thisPage=1&equTypeId=0"><span
					...
					<li><a
						href="${pageContext.request.contextPath}/equOrderClient/findByUserId?userId=${sessionScope.user.userId}"><span
			...
			<li><ul class="legal-menu nav nav-list collapse">
					<li><a
						href="${pageContext.request.contextPath}/fieldClient/findForClient?thisPage=1&fieldTypeId=0"><span
							class="fa fa-caret-right"></span>场地查询</a></li>
					<li><a
						href="${pageContext.request.contextPath}/cart/listField"><span
							class="fa fa-caret-right"></span>场地订单项</a></li>
					<li><a
						href="${pageContext.request.contextPath}/fieldOrderClient/findByUserId?userId=${sessionScope.user.userId}"><span
