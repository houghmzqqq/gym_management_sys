	...
	<div class="sidebar-nav">
		<ul>
			...
			<li><ul class="premium-menu nav nav-list collapse in">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/equOrderClient/findByUserId?userId=${sessionScope.user.userId}"><span
	...
	<div class="content">
		<div class="header">
			...
			<ul class="breadcrumb">
				...
				<li class="active">equ_order_query</li>
			</ul>
					...
					<c:forEach var="order" items="${equOrderVOs }"
						...
						<tr>
							...
							<td><c:if test="${order.equOrderStatement == 0 }">
									未支付 / <a href="#myModal2${items.index }" role="button" data-toggle="modal">
								支付</a></c:if>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<p class="error-text">
											<i class="fa fa-warning modal-icon"></i>确定要取消该订单吗？ <br>该操作不可撤销
										</p>
									</div>
									<div class="modal-footer">
										...
										<a
											href="${pageContext.request.contextPath }/equOrderClient/remove?equOrderId=${order.equOrderId}"
											data-toggle="modal" class="btn btn-danger">确定</a>
									</div>
								</div>
							</div>
						</div>
						<div class="modal small fade" id="myModal2${items.index }" tabindex="-1"
							role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
									...
									<div class="modal-footer">
										<button class="btn btn-default" data-dismiss="modal"
											aria-hidden="true">取消</button>
										<a
											href="${pageContext.request.contextPath }/equOrderClient/pay?equOrderId=${order.equOrderId}"
											data-toggle="modal" class="btn btn-danger">确定</a>
									</div>
								</div>
							</div>
